...
There is no concept of "users" or "accounts" in Collapse. Sessions are created to be shared to users and controlled by the Hack Club program that created it.
